...
experiments=(
    ...
    "python train_redi.py --train_file ./data/math/train.jsonl --num_epochs 1 --run_name teacher --max_train_samples 1000" 
    ...
    "python train_redi.py --train_file ./data/math/train.jsonl --num_epochs 1 --run_name teacher_no_curriculum --max_train_samples 1000" 
    ...
    "python train_redi.py --train_file ./data/math/train.jsonl --num_epochs 1 --run_name teacher_no_length --w_length 0.0 --max_train_samples 1000" 
    ...
    "python train_redi.py --train_file ./data/math/train.jsonl --num_epochs 1 --run_name teacher_no_answer --w_answer_pred 0.0 --max_train_samples 1000" 
    ...
    "python train_sft.py --train_file ./data/anli/train.jsonl --num_epochs 5"
    "python train_sft.py --train_file ./data/date/train.jsonl --num_epochs 5"
    "python train_sft.py --train_file ./data/math/train.jsonl --num_epochs 1 --max_train_samples 1000" 
